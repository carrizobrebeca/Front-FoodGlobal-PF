...
export const registerUser = createAsyncThunk('register/registerUser', async (userData, { dispatch, rejectWithValue }) => {
  try {
    ...
    return rejectWithValue(error.response.data.error || 'Error al registrar el usuario');
  }
});

// eliminar un usuario
export const deleteUser = createAsyncThunk('register/deleteUser', async (id, { rejectWithValue }) => {
  try {
