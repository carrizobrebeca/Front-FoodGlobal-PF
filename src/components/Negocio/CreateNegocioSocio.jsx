      ...
      <main className="lg:col-span-3 xl:col-span-5 bg-gray-100 p-8 h-[100vh] overflow-y-scroll">
        ...
        <section className="">
          ...
          <form>
            ...
            <div className="flex justify-around bg-gray-300 p-2 rounded-md mb-4 mt-4">
              ...
              <div className="flex gap-2 mb-2">
                ...
                >
                  <option value="">Seleccione negocio a editar</option>
...
export default CreateNegocioSocio;
