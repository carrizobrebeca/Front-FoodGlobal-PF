  ...
  useEffect(() => {
    const fetchPedido = async () => {
      try {
        ...
        const ventas = pedidosData.filter(
  ...
  return (
    <div className="grid lg:grid-cols-4 xl:grid-cols-6 min-h-screen">
      ...
      <main className="lg:col-span-3 xl:col-span-5 bg-gray-100 p-8 h-[100vh] overflow-y-scroll">
        ...
        <section className="">
          <form>
            <div className="flex justify-around p-10 bg-gray-200 text-blue-500 font-bold rounded-lg mt-10">Historial de ventas</div>
                ...
                {pedidos.length > 0 ? (
                  pedidos.map((pedido) => (
                    ...
                    >
                      ...
                      <button
                        onClick={() => handleEditEstado(pedido.id)}
                        className="col-span-1 flex items-center justify-center text-blue-600"
                        title="Detalle"
                      >
                        <svg
